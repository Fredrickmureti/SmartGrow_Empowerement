...
// Custom plugins layered on top of the Lovable TanStack config wrapper.
// The wrapper injects tanstackStart() + viteReact() and wires the
// `#tanstack-start-entry` virtual module, so we must NOT add those here.
const customPlugins: PluginOption[] = [
          ...
          shortcuts: [
            {
              ...
              icons: [
                { src: "/icons/finance-96.svg", sizes: "96x96", type: "image/svg+xml" },
              ],
            },
            {
              name: "Point of Sale",
            ...
            },
            {
              ...
              icons: [
                { src: "/icons/inventory-96.svg", sizes: "96x96", type: "image/svg+xml" },
              ],
            },
          ],
        },
