...
const COLUMNS: ReportColumn[] = [
  ...
  { key: "unearned_interest", header: "Unearned interest", format: "currency", width: "w-[140px]" },
  {
    key: "net_principal_outstanding",
    header: "Net principal o/s",
    format: "currency",
    width: "w-[140px]",
  },
  ...
  const rows = useMemo<ReportRow[]>(() => {
    const detail: ReportRow[] = data.map((r) => ({
      ...
      values: {
        ...
        unearned_interest: r.unearned_interest,
        net_principal_outstanding: r.net_principal_outstanding,
    ...
    detail.push({
      ...
      values: {
        ...
        unearned_interest: sum((r) => r.unearned_interest),
        net_principal_outstanding: sum((r) => r.net_principal_outstanding),
