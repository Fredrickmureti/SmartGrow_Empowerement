...
const REPORT_TYPES = [
  ...
  { value: "audit_trail", label: "Audit Trail", icon: Shield, category: "Compliance" },
  { value: "aged_payables", label: "Aged Payables", icon: CreditCard, category: "Payables" },
  { value: "expense_report", label: "Expense Report", icon: Receipt, category: "Payables" },
];
