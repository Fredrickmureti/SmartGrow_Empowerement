          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr>
                ...
                <td className={`px-4 py-2 font-medium ${data.agingBuckets.days30 > 0 ? "text-amber-600" : ""}`}>{formatCurrency(data.agingBuckets.days30)}</td>
                <td className={`px-4 py-2 font-medium ${data.agingBuckets.days60 > 0 ? "text-orange-600" : ""}`}>{formatCurrency(data.agingBuckets.days60)}</td>
                <td className={`px-4 py-2 font-medium ${data.agingBuckets.days90 > 0 ? "text-red-500" : ""}`}>{formatCurrency(data.agingBuckets.days90)}</td>
                <td className={`px-4 py-2 font-medium ${data.agingBuckets.over90 > 0 ? "text-destructive font-bold" : ""}`}>{formatCurrency(data.agingBuckets.over90)}</td>
