    ...
    <div className="space-y-4">
      <div className="space-y-2">
        {tiers.map((tier, i) => {
          ...
          return (
            <div key={i} className="min-w-0 grid grid-cols-2 items-end gap-2 @xl/page:grid-cols-6 @4xl/page:grid-cols-12 rounded-md border p-3">
              <div className="min-w-0 col-span-2 space-y-1 @4xl/page:col-span-5">
              ...
              <div className="min-w-0 col-span-1 space-y-1 @xl/page:col-span-2">
              ...
              <div className="min-w-0 col-span-2 flex justify-end @xl/page:col-span-1">
              ...
              <p className="min-w-0 col-span-2 text-xs text-muted-foreground @xl/page:col-span-6 @4xl/page:col-span-12">{LEVEL[tier.level].hint}</p>
            </div>
          );
        })}
      ...
      <div className="min-w-0 grid gap-2 @xl/page:grid-cols-2">
