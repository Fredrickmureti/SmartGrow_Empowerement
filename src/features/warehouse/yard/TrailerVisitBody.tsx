/**
 * TrailerVisitBody — the yard-visit management surface (ADR 0122).
 *
 * Rendered full width by `TrailerVisitWorkspace`. Boards show a read-only
 * `TrailerVisitPreview` and link here; the state machine, the departure
 * gate and the two audit trails are never driven from a side pane.
 *
...
export function TrailerVisitBody({
  visit,
  slots,
  docks,
  openMoveTask = null,
