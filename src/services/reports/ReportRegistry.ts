...
export const REPORT_REGISTRY: ReportDefinition[] = [
  ...
  // ─── Budget & Fixed Assets ───
  {
    ...
    relatedReports: ["analytic-budget-vs-actual"],
  },

  // ─── Analytic accounting (management dimension of the GL) ───
  {
    id: "analytic-account-statement",
    name: "Analytic Account Statement",
    description: "Posted journal lines per cost centre, project or department",
    category: "management",
    path: "/finance/reports/analytic-statement",
    icon: BookOpen,
    requiredFeature: "reports_financial",
    permission: "viewReports",
    reportType: "analytic-statement",
    drillDown: "route",
    keywords: [
      "analytic", "cost centre", "cost center", "department", "project",
      "dimension", "statement", "ledger",
    ],
    relatedReports: ["general-ledger", "analytic-profit-and-loss"],
  },
  {
    id: "analytic-profit-and-loss",
    name: "Analytic Profit & Loss",
    description: "Income and expense by cost centre, project or product line",
    category: "management",
    path: "/finance/reports/analytic-profit-and-loss",
    icon: TrendingUp,
    requiredFeature: "reports_financial",
    permission: "viewReports",
    reportType: "analytic-pnl",
    keywords: [
      "analytic", "p&l", "pnl", "profitability", "cost centre", "cost center",
      "project", "department", "product line", "margin",
    ],
    relatedReports: ["profit-and-loss", "analytic-account-statement"],
  },
  {
    id: "analytic-budget-vs-actual",
    name: "Analytic Budget vs Actual",
    description: "Plan versus posted actuals per analytic dimension",
    category: "management",
    path: "/finance/reports/analytic-budget-vs-actual",
    icon: PieChart,
    requiredFeature: "reports_financial",
    permission: "viewReports",
    reportType: "analytic-budget-vs-actual",
    keywords: [
      "analytic", "budget", "variance", "actual", "cost centre", "cost center",
      "project", "department", "plan",
    ],
    relatedReports: ["budget-report", "analytic-profit-and-loss"],
  },
  ...
  },
  {
    ...
    category: "management",
    path: "/finance/reports/consolidated-trial-balance",
    icon: BarChart3,
    permission: "viewReports",
  ...
  },
  {
    ...
    category: "management",
    path: "/finance/reports/consolidated-statements",
    icon: BarChart3,
    permission: "viewReports",
