...
exports.MockTerminalDriver = void 0;
class MockTerminalDriver {
    constructor() {
        this.vendor = 'mock';
        this.cache = new Map();
    ...
    async charge(req) {
        ...
        if (this.cancelling) {
            this.cancelling = false;
            const r = { ok: false, state: 'cancelled', reason: 'operator cancelled' };
...
exports.MockTerminalDriver = MockTerminalDriver;
//# sourceMappingURL=MockTerminalDriver.js.map