...
- [Certificate rendering architecture](mem://features/certificate-rendering.md) — Statutory certs (P9) render via ONE country-agnostic v3 AST → compile() HTML/CSS → paged.js client-side; WYSIWYG editor only; never rebuild the pdf-lib hand-drawn renderers (v1/v2/astPdfProducer)
