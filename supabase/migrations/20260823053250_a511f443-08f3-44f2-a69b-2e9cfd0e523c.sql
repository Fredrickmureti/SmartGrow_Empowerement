CREATE OR REPLACE FUNCTION public.create_invoice_atomic(p_header jsonb, p_items jsonb, p_user_id uuid DEFAULT NULL::uuid, p_idempotency_key text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  LOOP
    ...
    v_lines := v_lines || jsonb_build_object(
      ...
      'analytic_account_id', NULLIF(v_item->>'analytic_account_id',''),
  ...
  INSERT INTO public.invoice_items (
    ...
    lot_number, serial_number, analytic_account_id
  )
  SELECT
    v_invoice_id,
    ...
    NULLIF(i->>'analytic_account_id','')::uuid
