...
-- 1. Patch variance trigger: accept force-close override path; friendlier message
...
BEGIN
  ...
  v_has_override :=
    ...
    OR (NEW.variance_override_id IS NOT NULL AND NEW.force_closed_by IS NOT NULL);
...
-- 2. Force-close RPC: stamp both override columns and return friendly fields
...
BEGIN
  ...
  UPDATE public.pos_shifts
     SET status                   = 'closed',
         ...
         variance_override_pin_id = p_override_id,
