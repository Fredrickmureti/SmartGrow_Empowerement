-- Phase 3 of branch-dimension audit: make branch reporting REAL.
-- Both RPCs already filter by org + business; this adds the missing branch filter.

-- =============================================================
-- get_account_movements: add _branch_id (NULL = all branches)
-- =============================================================
...
-- =============================================================
-- get_general_ledger: add _branch_id (NULL = all branches)
-- Keep return signature identical; recreate to add the new param.
-- =============================================================
