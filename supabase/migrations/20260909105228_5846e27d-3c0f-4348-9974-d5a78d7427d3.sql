...
BEGIN
  ...
  INSERT INTO public.mf_clients (
    ...
    next_of_kin_phone, loan_officer_id, status, notes, created_by
  ) VALUES (
    p_business_id,
    v_branch,
...
REVOKE ALL ON FUNCTION public.mf_register_client(uuid, jsonb, uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.mf_register_client(uuid, jsonb, uuid) TO authenticated;