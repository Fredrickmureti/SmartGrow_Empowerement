...
BEGIN
  ...
  -- Journal numbering is per-company. Fall back to the company on the bills
  -- when the caller omitted it, and fail with an actionable message otherwise.
