CREATE OR REPLACE FUNCTION public.mf_create_loan_from_application(
  ...
  p_expected_disbursement_date date DEFAULT NULL::date,
...
BEGIN
  ...
  INSERT INTO public.mf_loans (
    ...
    interest_rate_period, interest_collection, interest_recognition,
    grace_period_installments, fees, penalty_rate,
  ...
  VALUES (
    ...
    COALESCE(v.interest_recognition,'on_repayment'),
