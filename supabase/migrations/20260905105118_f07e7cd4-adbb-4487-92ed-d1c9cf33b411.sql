...
BEGIN
  ...
  -- Mirrored totals: the reversal swaps debit and credit on every line.
  ...
  -- Header already carries the final totals; the recompute trigger would try to
  -- UPDATE this already-posted header and be rejected by the immutability guard.
