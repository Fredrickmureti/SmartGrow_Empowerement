...
REVOKE ALL ON FUNCTION public.mf_collect_group_admission_fees(uuid, date, text, text, text, jsonb, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.mf_collect_group_admission_fees(uuid, date, text, text, text, jsonb, text) TO authenticated;