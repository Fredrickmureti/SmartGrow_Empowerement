...
BEGIN
  ...
  INSERT INTO public.projects(id,organization_id,business_id,project_number,name,manager_id,is_billable,allow_timesheets,status,time_entry_open_to_org)
  VALUES (proj,org,biz,'W5-P1','Probe project',u_pm,false,true,'active',true);
