...
BEGIN
  ...
  INSERT INTO public.bank_transactions (
    organization_id, business_id, branch_id, bank_account_id, external_transaction_id,
    transaction_date, posting_date, description, reference, amount, transaction_type,
    journal_entry_id, is_reconciled, lifecycle_status
  ) VALUES (
    v_org, b.business_id, b.branch_id, p_bank_account_id, 'mf-collection-banking-' || v_id::text,
    v_date, v_date, v_desc, COALESCE(p_reference, b.batch_number), v_total, 'credit',
    v_je, false, 'active'
