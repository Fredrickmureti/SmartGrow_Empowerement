...
-- Function to finalize a restaurant draft transaction (pending -> completed)
-- This avoids creating a duplicate transaction when paying a table order.
...
BEGIN
  ...
  -- Generate a final transaction number (replace draft number)
