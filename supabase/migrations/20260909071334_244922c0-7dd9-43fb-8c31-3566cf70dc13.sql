CREATE OR REPLACE FUNCTION public.mf_pay_client_charge(p_charge_id uuid, p_paid_on date DEFAULT NULL::date, p_method text DEFAULT 'cash'::text, p_reference text DEFAULT NULL::text, p_notes text DEFAULT NULL::text, p_amount numeric DEFAULT NULL::numeric)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
