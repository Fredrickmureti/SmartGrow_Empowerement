...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'location_id', v_dest, 'override_applied', v_overridden);
END; $function$;

REVOKE ALL ON FUNCTION public.complete_putaway_task(uuid, uuid, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.complete_putaway_task(uuid, uuid, text) TO authenticated, service_role;
