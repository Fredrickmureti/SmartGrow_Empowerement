...
BEGIN
  ...
  INSERT INTO public.stock_transfers (
    ...
    'Phase F2 — warehouse-split landed cost rehearsal'
  ...
  INSERT INTO public.stock_transfer_items (
    ...
    v_tr, v_cable, 40, 40, v_branch, v_uom, 40, 'PCE', 'PCE', 1
  ...
  v_res := public.complete_stock_transfer_atomic(
    v_tr,
    jsonb_build_array(jsonb_build_object('id', v_tri, 'quantity_received', 40)),
    v_actor);
  RAISE NOTICE 'complete: %', v_res;
  IF NOT COALESCE((v_res->>'success')::boolean, false) THEN
