...
BEGIN
  ...
  -- Difference footprint, straight off the count session lines.
  SELECT COUNT(*),
...
REVOKE ALL ON FUNCTION public.wms_count_governance_preview(uuid) FROM public;
GRANT EXECUTE ON FUNCTION public.wms_count_governance_preview(uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.wms_count_governance_preview(uuid) TO service_role;