...
DELETE FROM public.purchase_orders WHERE po_number LIKE 'PO-SIM-%'
  AND NOT EXISTS (SELECT 1 FROM public.goods_receipts g WHERE g.purchase_order_id = purchase_orders.id);
