...
BEGIN
  ...
  -- Only true receipt/kitchen documents may use ESC/POS/thermal routing.
  -- Business documents such as invoices and delivery notes must remain A4
  -- PDF documents, regardless of stale tenant policy rows.
        ...
        THEN
          v_policy_target := jsonb_build_object(
            ...
            'params',        jsonb_build_object(
              ...
              'coerced_to_pdf', (v_policy_medium = 'pdf' AND NOT v_is_thermal_kind AND (v_policy.render_mode = 'escpos' OR v_policy.paper_format IN ('80mm', '58mm', '40mm')))
            )
          );
