...
BEGIN
    ...
    IF p_app_id = 'pos' THEN
        ...
        -- Pick the oldest active business for this org (no is_default column exists)
        ...
        -- Only create a default register if a business exists
        IF v_default_business_id IS NOT NULL THEN
            IF NOT EXISTS (
