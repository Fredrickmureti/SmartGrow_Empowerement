-- Natural-sign closing balances, matching the shared accounting kernel
  ...
  LOOP
    ...
    SELECT
      ...
      CASE WHEN a.account_type IN ('asset','expense')
           THEN c.opening_balance + c.total_debit - c.total_credit
...
BEGIN
  ...
  -- Debit-equivalents: a translated ledger balances when debits equal credits,
  -- and whatever is left over IS the cumulative translation adjustment.
  residual AS (
