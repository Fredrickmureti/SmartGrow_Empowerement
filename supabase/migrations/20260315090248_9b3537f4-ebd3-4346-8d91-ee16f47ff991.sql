-- Fix record_payment_atomic: change 'currency' to 'base_currency' on organizations table
...
BEGIN
  ...
  -- Cr Customer Credits (overpayment portion)
  ...
  -- Handle overpayment: auto-create credit note
  IF v_overpayment > 0 THEN
