...
REVOKE EXECUTE ON FUNCTION public.get_journal_report(uuid, date, date, uuid, uuid, text[], integer, integer) FROM PUBLIC, anon;
...
REVOKE EXECUTE ON FUNCTION public.get_general_ledger(uuid, date, date, uuid, uuid[], boolean, uuid) FROM PUBLIC, anon;