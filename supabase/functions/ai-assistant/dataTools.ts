...
export const DATA_TABLES: Record<string, TableSpec> = {
  ...
  products: {
    columns: ["id", "name", "sku", "type", "selling_price", "cost_price", "currency", "quantity_on_hand", "reorder_level", "is_active", "business_id"],
    orgColumn: "organization_id",
    businessColumn: "business_id",
    description: "Product catalogue and stock levels.",
  },
  employees: {
